...
function createCamera() {
    ...
    camera.position.set(-30, 40, 30); // X, Y, Z axis's value
    camera.lookAt(0, 0, 0);
    return camera;
}
...
// Save a copy of renderer to global scope
...
// Move Sphere 10 metres to the right
sphere.position.x = 10;
// Move the light 5 metres to right, 10 m up and 10 m away from camera
